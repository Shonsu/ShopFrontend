...
export class AdminOrderService {
    ...
    getSalesStatistics(from: string, to: string, orderStatus: string): Observable<any> {
        return this.http.get<any>(`/api/admin/orders/stats?from=${from}&to=${to}&orderStatus=${orderStatus}`);
    }
}
